...
@dso_cache = dso_local local_unnamed_addr global [516 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.14_name, ; name: libaot-Microsoft.Extensions.Http.dll.so
		ptr null; void* handle (0x0)
	}, ; 1
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 1734834933741044418, ; hash 0x18135f2e4192c2c2, from name: aot-Taller 3.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Taller 3.dll.so
		ptr null; void* handle (0x0)
	}, ; 42
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.12_name, ; name: libaot-Microsoft.Extensions.Diagnostics.dll.so
		ptr null; void* handle (0x0)
	}, ; 81
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 7984217154470084537, ; hash 0x6ecda33325c4ffb9, from name: Taller 3.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Taller 3.dll.so
		ptr null; void* handle (0x0)
	}, ; 206
	...
	%struct.DSOCacheEntry {
		i64 9537294248700339738, ; hash 0x845b4696a428e61a, from name: Taller 3
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Taller 3.dll.so
		ptr null; void* handle (0x0)
	}, ; 260
	...
	%struct.DSOCacheEntry {
		i64 9851094337451814825, ; hash 0x88b61e1b48ad6fa9, from name: aot-Taller 3
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Taller 3.dll.so
		ptr null; void* handle (0x0)
	}, ; 268
	...
	%struct.DSOCacheEntry {
		i64 14999783696637473758, ; hash 0xd029efccc1c5b3de, from name: libaot-Taller 3.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Taller 3.dll.so
		ptr null; void* handle (0x0)
	}, ; 422
	...
	%struct.DSOCacheEntry {
		i64 18134083993271460735, ; hash 0xfba935503a0ae37f, from name: libaot-Taller 3
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Taller 3.dll.so
		ptr null; void* handle (0x0)
	}, ; 503
...
@.env.3 = private unnamed_addr constant [37 x i8] c"d532aa64-42a0-4449-865a-0184f962cf85\00", align 16
...
;ApplicationConfig
@.ApplicationConfig.0_android_package_name = private unnamed_addr constant [24 x i8] c"com.companyname.taller3\00", align 16
...
@.DSOCacheEntry.7_name = private unnamed_addr constant [23 x i8] c"libaot-Taller 3.dll.so\00", align 16
...
@.DSOCacheEntry.12_name = private unnamed_addr constant [47 x i8] c"libaot-Microsoft.Extensions.Diagnostics.dll.so\00", align 16
...
@.DSOCacheEntry.14_name = private unnamed_addr constant [40 x i8] c"libaot-Microsoft.Extensions.Http.dll.so\00", align 16
