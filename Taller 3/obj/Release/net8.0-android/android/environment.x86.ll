...
@dso_cache = dso_local local_unnamed_addr global [516 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 392533629, ; hash 0x1765967d, from name: libaot-Taller 3.dll.so
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 1142409116, ; hash 0x4417c79c, from name: Taller 3
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Taller 3.dll.so
		ptr null; void* handle (0x0)
	}, ; 129
	...
	%struct.DSOCacheEntry {
		i64 2522685231, ; hash 0x965d1f2f, from name: aot-Taller 3.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Taller 3.dll.so
		ptr null; void* handle (0x0)
	}, ; 298
	...
	%struct.DSOCacheEntry {
		i64 2920834124, ; hash 0xae18644c, from name: libaot-Taller 3
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Taller 3.dll.so
		ptr null; void* handle (0x0)
	}, ; 355
	%struct.DSOCacheEntry {
		i64 2930524320, ; hash 0xaeac40a0, from name: aot-Taller 3
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Taller 3.dll.so
		ptr null; void* handle (0x0)
	}, ; 356
	...
	%struct.DSOCacheEntry {
		i64 2939475246, ; hash 0xaf34d52e, from name: Taller 3.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Taller 3.dll.so
		ptr null; void* handle (0x0)
	}, ; 359
